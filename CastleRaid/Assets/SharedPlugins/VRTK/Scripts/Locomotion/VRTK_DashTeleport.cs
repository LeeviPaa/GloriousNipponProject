...
namespace VRTK
{
    ...
    public struct BlinkDashEventArgs
    {
    ...
    /// <param name="e"><see cref="BlinkDashEventArgs"/></param>
    public delegate void BlinkDashEventHandler(object sender, BlinkDashEventArgs e);
    ...
    public class VRTK_DashTeleport : VRTK_HeightAdjustTeleport
    {
        ...
        /// </summary>
        public event BlinkDashEventHandler WillDashThruObjects;
        /// <summary>
        /// Emitted when obstacles have been crossed and the dash has ended.
        /// </summary>
        public event BlinkDashEventHandler DashedThruObjects;
        ...
        public virtual void OnWillDashThruObjects(BlinkDashEventArgs e)
        {
        ...
        public virtual void OnDashedThruObjects(BlinkDashEventArgs e)
        {
        ...
        protected virtual BlinkDashEventArgs SetDashTeleportEvent(RaycastHit[] hits)
        {
            BlinkDashEventArgs e;
            e.hits = hits;
            return e;
        }
    }
